        ...
        {selectedBook && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6 drop-shadow-2xl">
            ...
            >
              ...
              <div className="w-full md:w-2/5 bg-slate-50 p-8 md:p-12 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-slate-100">
                <div className="w-full aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl shadow-indigo-500/20 mb-8">
                  {selectedBook.cover ? (
                    ...
                    <div className="w-full h-full flex flex-col items-center justify-center bg-white">
                      <BookOpen size={80} className="text-slate-100" />
                    </div>
                  )}
                </div>
                <div className={`w-full py-4 rounded-2xl flex items-center justify-center gap-3 font-black font-bengali text-lg ${
                  ...
                  {selectedBook.status === 'Available' ? 'পাওয়া যাবে (Available)' : 'পাওয়া যাবে না (Issued)'}
                </div>
              </div>
